...
use mail::test::helpers::{spawn_app, spawn_connector_app};
use mail::connectors::web::WebMailConnectorBuilder;
...
async fn health_check_works() {
    ...
    let connector_app = spawn_connector_app(
        WebMailConnectorBuilder::build(
            format!("{}/mail", &app.address)
        ),
