...
use files::connectors::inner::InnerFilesConnectorBuilder;
use files::test::helpers::{spawn_connector_app, spawn_configuration};
...
async fn health_check_works() {
    ...
    let connector_app = spawn_connector_app(
        InnerFilesConnectorBuilder::build(configuration.clone()),
